...
export const site = {
  // ------------------------------------------------------------------ MARQUE
  brand: {
    name: 'Clarityllab', // nom de la marque (ex. « Focusla »). Vide => le logo affiche ui.brandFallback.
    tagline: 'Coaching sportif expliqué simplement', // sur-titre court (pied de page, JSON-LD)
  },

  /** URL publique complète, sans barre oblique finale. Doit correspondre à public/CNAME. */
  url: 'https://clarityllab.shop',
